 ...
 */
const ParticleEngine = function(options) {
    var defaults = {
        gravityX: 0,
        gravityY: 1
    };
 ...
 */
const ParticleTimedEmitter = function(options) {
    var defaults = {
        emitter: null,
        engine: null,
        x: 0,
...
/**
 * Appearance that uses the Sprite class from gameutils.js
