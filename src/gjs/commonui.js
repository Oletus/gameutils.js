...
commonUI.createUI = function(options) {
    ...
    var followTwitterButton = commonUI.createFollowOnTwitterButton({
    ...
    var fsButton = commonUI.createFullscreenButton({
...
commonUI.createFullscreenButton = function(options) {
...
commonUI.createFollowOnTwitterButton = function(options) {
    ...
    var sprite = new Sprite(commonUI.twitterLogoSrc, Sprite.turnSolidColored(options.fillStyle));
